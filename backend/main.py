...
# !pip install transformers sentencepiece accelerate ipywidgets langchain-ollama langgraph pydantic PyPDF2 reportlab
import os
import re
...
def chatbot_agent(state: PrismaState, prompt: str, checkpointer: InMemorySaver, model: str = MODEL_NAME):
    # Chat model
